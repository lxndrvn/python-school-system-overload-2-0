...
class ExampleData():
    def __init__(self):
        ...
        mentors=[{'first_name': 'Matyi', 'last_name': 'Szabó', 'school': 'Budapest', 'email': 'matyi@gmail.com'},
                 {'first_name': 'Imi', 'last_name': 'Fodor', 'school': 'Budapest', 'email': 'imi@gmail.com'},
                 {'first_name': 'Laci', 'last_name': 'Molnár', 'school': 'Budapest', 'email': 'laci@gmail.com'},
                 {'first_name': 'Agnieszka', 'last_name': 'Koszany', 'school': 'Krakow', 'email': 'agni@gmail.com'},
                 {'first_name': 'Róbert', 'last_name': 'Kohányi', 'school': 'Miskolc', 'email': 'robert@gmail.com'}]
